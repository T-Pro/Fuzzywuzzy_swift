...
public extension String {
  ...
  static private func _fuzzProcessAndSort(str: String, fullProcess: Bool = true) -> String {
    let str = fullProcess ? StringProcessor.process(str: str) : str
    return Array(str.components(separatedBy: " "))
      .sorted()
      .joined(separator: " ")
  ...
  static func _token_set(str1: String, str2: String, partial: Bool = true, fullProcess: Bool = true) -> Int {
    ...
    sorted_sect   = sorted_sect.trimmingCharacters(in: CharacterSet(charactersIn: " "))
    combined_1to2 = combined_1to2.trimmingCharacters(in: CharacterSet(charactersIn: " "))
    combined_2to1 = combined_2to1.trimmingCharacters(in: CharacterSet(charactersIn: " "))
  ...
  static func fuzzTokenSetRatio(
    ...
    _token_set(str1: str1, str2: str2, partial: false, fullProcess: fullProcess)
  }
  ...
  static func fuzzPartialTokenSetRatio(
    ...
    _token_set(str1: str1, str2: str2, partial: true, fullProcess: fullProcess)
  }
}
